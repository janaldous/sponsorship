...
import com.janaldous.sponsorship.companieshouse.CompaniesHouseService;
...
public class NameComparisonIT {
	...
	@Autowired
	private CompaniesHouseService chService;
...
//			log.info("score = " + score + " " + name1 + " " + name2);
	...
	public void test2() {
		...
		for (RelevantSponsor sponsor: sponsors) {
			...
			if (calculateLikeness <= CompaniesHouseService.LIKENESS_THRESHOLD) {
